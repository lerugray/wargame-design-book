...
title, no series, no subtitle, English, 358 pages, 6x9, B&W
...
0.8950 in). I'll handle the file uploads myself when KDP asks.
...
| Cover | I'll upload `wargame-design-book-cover.pdf` (wraparound, spine 0.8950 in for 358pp cream) |
...
358-page B&W 6x9 cream paperback with ~$5.30 print cost
(KDP's actual formula: $1.00 fixed + $0.012/page = $1.00 + $4.296):

- $24.99 × 0.6 = $14.994
- $14.994 - $5.30 = **$9.70 per copy** (was $9.67 at 360pp pre-revision; KDP UI authoritative on submission, expect ±$0.05 from rounding)
...
- [ ] Cover spine width matches KDP's calculated value for 358 pages
...
### Pricing
- [ ] List price = $24.99
- [ ] Royalty per copy ≈ $9.70 (within $0.50)
