---
title: "Appendix C: Sample Design Exercise"
nav_order: 102
layout: chapter
---
...
4.0 Movement (including terrain effects)
5.0 Combat (including the CRT)
6.0 Reinforcements (when and where)
7.0 Special Rules (weather, air power, supply, whatever your design requires)
